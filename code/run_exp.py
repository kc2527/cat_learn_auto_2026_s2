...
EEG_BREAK_TRIALS = (249, 499)  # Zero-based: after session trials 250 and 500.
N_PROBE = 50
    ...
    while running:
        ...
        # --------------------- STATE: FEEDBACK ---------------------
            ...
            if time_state > 1000:
                ...
                if (EEG_ENABLED and session_num == 1 and trial == FIRST_EEG_SLOW_TRIALS - 1):
